...
{
	/** 初始化向量值 */
	Vector3 zero = Vector3(9, 25, 40);		
	Vector3 view = Vector3(5, 0, 0);		
...
{
	/** 更新摄像机 */
	m_Position.x += m_UpVector.x * speed;    /**< 根据速度更新位置 */
	m_Position.z += m_UpVector.z * speed;
	m_Position.y += m_UpVector.y * speed;

	m_View.x += m_UpVector.x * speed;		 /**< 根据速度更新方向 */
	m_View.y += m_UpVector.y * speed;
	m_View.z += m_UpVector.z * speed;
}

/** 设置视点 */
glm::mat4 Camera::setLook()
{
	///** 设置视口 */
	...
	glm::mat4 view=glm::lookAt(
		...
		glm::vec3(m_View.x, m_View.y, m_View.z),
